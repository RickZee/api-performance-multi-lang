...
KAFKA_TOPIC = os.getenv('KAFKA_TOPIC', 'filtered-loan-payment-submitted-events-msk')
AWS_REGION = os.getenv('AWS_REGION', 'us-east-1')
CONSUMER_GROUP_ID = os.getenv('CONSUMER_GROUP_ID', 'loan-payment-consumer-group-msk')
...
def main():
    logger.info("Starting Loan Payment Consumer (MSK)...")
