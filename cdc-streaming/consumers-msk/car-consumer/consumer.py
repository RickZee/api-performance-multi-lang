...
KAFKA_TOPIC = os.getenv('KAFKA_TOPIC', 'filtered-car-created-events-msk')
AWS_REGION = os.getenv('AWS_REGION', 'us-east-1')
CONSUMER_GROUP_ID = os.getenv('CONSUMER_GROUP_ID', 'car-consumer-group-msk')
...
def main():
    logger.info("Starting Car Consumer (MSK)...")
