#!/usr/bin/env python3
"""
Dealer 001 Consumer (Tesla Service Center - San Francisco)
Consumes filtered service events from Kafka topic: filtered-service-events-dealer-001
...
logger = logging.getLogger('dealer-001-consumer')

# Configuration from environment variables
KAFKA_BOOTSTRAP_SERVERS = os.getenv('KAFKA_BOOTSTRAP_SERVERS', 'kafka:29092')
KAFKA_TOPIC = os.getenv('KAFKA_TOPIC', 'filtered-service-events-dealer-001')
KAFKA_API_KEY = os.getenv('KAFKA_API_KEY', '')
KAFKA_API_SECRET = os.getenv('KAFKA_API_SECRET', '')
CONSUMER_GROUP_ID = os.getenv('CONSUMER_GROUP_ID', 'dealer-001-service-consumer-group')
...
def main():
    ...
    consumer_config = {
        ...
        'client.id': 'dealer-001-consumer-client',
