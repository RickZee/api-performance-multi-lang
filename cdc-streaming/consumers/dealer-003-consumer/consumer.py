#!/usr/bin/env python3
"""
Dealer 003 Consumer (Mercedes Service Center - New York)
Consumes filtered service events from Kafka topic: filtered-service-events-dealer-003
...
logger = logging.getLogger('dealer-003-consumer')

# Configuration from environment variables
KAFKA_BOOTSTRAP_SERVERS = os.getenv('KAFKA_BOOTSTRAP_SERVERS', 'kafka:29092')
KAFKA_TOPIC = os.getenv('KAFKA_TOPIC', 'filtered-service-events-dealer-003')
...
def main():
    ...
    consumer_config = {
        ...
        'client.id': 'dealer-003-consumer-client',
