...
_config = None
_pool = None  # Global pool for PG version
...
async def _initialize_service():
    ...
    if _service is None:
        ...
        _service = EventProcessingService(
            ...
            api_name=API_NAME,
            should_close_connection=True  # Service will detect pool connection and release
        )
        ...
        try:
            ...
            return _create_response(
                500,
                {
                    ...
                    "message": "Handler called from within running event loop",
                    "status": 500,
                },
            )
        except RuntimeError:
