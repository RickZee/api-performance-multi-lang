...
const (
	EventService_ProcessEvent_FullMethodName = "/com.example.grpc.EventService/ProcessEvent"
	EventService_HealthCheck_FullMethodName  = "/com.example.grpc.EventService/HealthCheck"
)
...
func (c *eventServiceClient) HealthCheck(ctx context.Context, in *HealthRequest, opts ...grpc.CallOption) (*HealthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedEventServiceServer) HealthCheck(context.Context, *HealthRequest) (*HealthResponse, error) {
...
func _EventService_HealthCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventServiceServer).HealthCheck(ctx, req.(*HealthRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EventService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "com.example.grpc.EventService",
